      ...
      <div className={`max-w-6xl mx-auto px-6 py-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-5">
            ...
            {/* Performance Statistics for Freelancers */}
            {isFreelancer && (
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                ...
                <div className="space-y-4">
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-xs font-medium text-slate-600">Overall Rating</div>
                    <div className="text-xs text-slate-500">out of 5.0</div>
                  </div>
                  <div className="text-center p-3 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-600 mb-1">{data.completedProjects || 0}</div>
                    <div className="text-xs font-medium text-slate-600">Completed Projects</div>
                  </div>
                  {data.ratingDetails && (
                    <>
                      <div className="text-center p-3 bg-purple-50 rounded-lg">
                        ...
                        <div className="text-xs font-medium text-slate-600">Technical Skills</div>
                      </div>
                      <div className="text-center p-3 bg-orange-50 rounded-lg">
                        <div className="text-xl font-bold text-orange-600 mb-1">
                          {data.ratingDetails.communication ? data.ratingDetails.communication.toFixed(1) : '0.0'}
                        </div>
                        <div className="text-xs font-medium text-slate-600">Communication</div>
                      </div>
                      <div className="text-center p-3 bg-pink-50 rounded-lg">
                        ...
                        <div className="text-xs font-medium text-slate-600">Professionalism</div>
                      </div>
                    </>
                  )}
                </div>
            ...
            {/* Social Links for Freelancers */}
            {isFreelancer && (data.linkedIn || data.github) && (
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {data.linkedIn && (
                    ...
                    >
                      ...
                      <span className="text-xs font-medium text-blue-700 group-hover:text-blue-800">LinkedIn</span>
                    </a>
                  )}
                  {data.github && (
                    <a
                    ...
                    >
                      <svg className="w-6 h-6 text-gray-700 mb-2" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-xs font-medium text-gray-700 group-hover:text-gray-800">GitHub</span>
                    </a>
                  )}
                </div>
              </div>

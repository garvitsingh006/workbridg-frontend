...
const Register: React.FC = () => {
    ...
    useEffect(() => {
        // Load Google script dynamically (IMPORTANT!)
        ...
        script.onload = () => {
            ...
            const width = btn.offsetWidth; // numeric width (Google requires this)
    ...
    return (
        <div className="min-h-screen bg-white flex relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 text-white">
                    <div className="mb-8">
                        ...
                        <p className="text-xl text-gray-300 leading-relaxed">
                            Experience dispute-free collaboration with our
                            admin-mediated platform trusted by thousands.
                        </p>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
                <div
                    className={`w-full max-w-md transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                >
                    {/* Logo and Header */}
